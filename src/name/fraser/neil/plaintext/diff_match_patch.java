...
public class diff_match_patch {
     ...
     */
    public float Diff_Timeout = 1.0f;// 设置超时时间
    /**
     * Cost of an empty edit operation in terms of edit characters.
     */
    public short Diff_EditCost = 4;// 至少要多少个相同的字符(包括空格)
    /**
    ...
    /**
     * 找出两个文本的之间的不同.通过在比较之前来截取任何的前缀和后缀来简化问题.
     * 
    ...
    public LinkedList<Diff> diff_main(String text1, String text2,
        ...
        // Compute the diff on the middle block 计算中间块的差异
        diffs = diff_compute(text1, text2, checklines);

        // 恢复 Restore the prefix and suffix
    ...
    /**
     * 
     * 判断两个字符串的常见的后缀,返回从后数不相同后缀的index
     * 
    ...
    public static void main(String[] args) {
        ...
        System.out.println(unescapeForEncodeUriCompatability("%21%"));
    }
}
