...
public class diff_match_patch_test extends TestCase {
    ...
    public void testDiffHalfmatch() {
        // Detect a halfmatch.
        assertNull("diff_halfMatch: No match.",
    ...
    public void testDiffCharsToLines() {
        ...
        assertEquals("diff_charsToLines:", new Diff(EQUAL, "a"), new Diff(
                EQUAL, "a"));
    ...
    public void testDiffCleanupSemantic() {
        ...
        diffs = diffList(new Diff(DELETE, "a"), new Diff(INSERT, "b"),
                new Diff(EQUAL, "cd"), new Diff(DELETE, "e"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals(
                "diff_cleanupSemantic: No elimination.",
                diffList(new Diff(DELETE, "a"), new Diff(INSERT, "b"),
                        new Diff(EQUAL, "cd"), new Diff(DELETE, "e")), diffs);
    ...
    public void testDiffPrettyHtml() {
        ...
        assertEquals(
                "diff_prettyHtml:",
                "<SPAN TITLE=\"i=0\">a&para;<BR></SPAN><DEL STYLE=\"background:#FFE6E6;\" TITLE=\"i=2\">&lt;B&gt;b&lt;/B&gt;</DEL><INS STYLE=\"background:#E6FFE6;\" TITLE=\"i=2\">c&amp;d</INS>",
    ...
    public void testDiffPath() {
        ...
        assertTrue("diff_footprint:",
                dmp.diff_footprint(1, 10) != dmp.diff_footprint(10, 1));
        ...
        LinkedList<Diff> diffs = diffList(new Diff(INSERT, "W"), new Diff(
                DELETE, "A"), new Diff(EQUAL, "1"), new Diff(DELETE, "B"),
                new Diff(EQUAL, "2"), new Diff(INSERT, "X"), new Diff(DELETE,
                        "C"), new Diff(EQUAL, "3"), new Diff(DELETE, "D"));
        assertEquals("diff_path1: Single letters.", diffs,
                dmp.diff_path1(v_map, "A1B2C3D", "W12X3"));

        // Trace a path from front to back.
        v_map.remove(v_map.size() - 1);
        diffs = diffList(new Diff(EQUAL, "4"), new Diff(DELETE, "E"), new Diff(
                INSERT, "Y"), new Diff(EQUAL, "5"), new Diff(DELETE, "F"),
                new Diff(EQUAL, "6"), new Diff(DELETE, "G"), new Diff(INSERT,
                        "Z"));
        assertEquals("diff_path2: Single letters.", diffs,
        ...
        diffs = diffList(new Diff(INSERT, "WX"), new Diff(DELETE, "AB"),
                new Diff(EQUAL, "12"));
        assertEquals("diff_path1: Double letters.", diffs,
        ...
        diffs = diffList(new Diff(DELETE, "CD"), new Diff(EQUAL, "34"),
                new Diff(INSERT, "YZ"));
        assertEquals("diff_path2: Double letters.", diffs,
    ...
    public void testDiffMain() {
        ...
        diffs = diffList(new Diff(INSERT, "x"), new Diff(EQUAL, "a"), new Diff(
                DELETE, "b"), new Diff(INSERT, "x"), new Diff(EQUAL, "c"),
                new Diff(DELETE, "y"), new Diff(INSERT, "xabc"));
        ...
        a = "1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n";
        b = "abcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\n";
        assertEquals("diff_main: Simple.", dmp.diff_main(a, b, true),
                dmp.diff_main(a, b, false));
    ...
    public void testPatchApply() {
        ...
        Object[] results = dmp.patch_apply(patches,
                "The quick brown fox jumps over the lazy dog.");
        boolean[] boolArray = (boolean[]) results[1];
        String resultStr = results[0] + "\t" + boolArray[0] + "\t"
                + boolArray[1];
